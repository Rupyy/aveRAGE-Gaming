...
if($_GET["action"]=="add") {
	...
	echo'
		...
		<table cellpadding="4" cellspacing="1" bgcolor="#cccccc">
			...
			<tr bgcolor="#ffffff">
				<td>'.$_language->module['path_url'].': <i>('.$_language->module['o_no_embed'].')</i></td>
...
elseif($_GET["action"]=="unactivated") {
	...
	if($pages>1) $page_link = makepagelink("index.php?site=myvideos&sort=$sort&type=$type", $page, $pages);
