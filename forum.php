...
function boardmain() {
	...
	while($dk=mysql_fetch_array($kath)) {
		$kathname = "<a class='forum_katg_link' href='index.php?site=forum&amp;cat=".$dk['catID']."'>".$dk['name']."</a>";
...
function showboard($board) {
	...
	$actions='<a class="forum" href="index.php?site=search">'.$_language->module['search_image'].'</a>';
	if($loggedin) {
		$mark='<img src="images/forum_icon_markall.png" width="16" height="16" align="left" />&nbsp; <a href="index.php?site=forum&amp;board='.$board.'&amp;action=markall">'.$_language->module['mark_topics_read'].'</a>';
		if($writer) $actions.=' <a class="forum" href="index.php?site=forum&amp;addtopic=true&amp;board='.$board.'">'.$_language->module['newtopic_image'].'</a>';
	} else $mark='';
	...
	if($anztopics) {
		...
		while($dt=mysql_fetch_array($topics)) {
			...
			if($dt['sticky']) {
				$onicon = '<img src="images/icons/foldericons/newsticky.png" alt="'.$_language->module['sticky'].'" />';
				$officon = '<img src="images/icons/foldericons/sticky.png" alt="'.$_language->module['sticky'].'" />';
				$onhoticon = '<img src="images/icons/foldericons/newsticky.png" alt="'.$_language->module['sticky'].'" />';
				$offhoticon = '<img src="images/icons/foldericons/sticky.png" alt="'.$_language->module['sticky'].'" />';
			}
			else {
				$onicon = '<img src="images/icons/foldericons/newfolder.png" alt="'.$_language->module['new_posts'].'" />';
				$officon = '<img src="images/icons/foldericons/folder.png" alt="no '.$_language->module['new_posts'].'" />';
				$onhoticon = '<img src="images/icons/foldericons/newhotfolder.png" alt="'.$_language->module['new_posts'].' ['.$_language->module['popular'].']" />';
				$offhoticon = '<img src="images/icons/foldericons/hotfolder.png" alt="no '.$_language->module['new_posts'].' ['.$_language->module['popular'].']" />';
			}

			if($dt['closed']) $folder='<img src="images/icons/foldericons/lockfolder.png" alt="'.$_language->module['closed'].'" />';
